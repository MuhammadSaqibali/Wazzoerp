...
class AttendanceEmployeeController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $todayAttendance = AttendanceEmployee::query()->where('employee_id', '=', $employeeId)->whereDate('date', date('Y-m-d'))->first();

        $todayAttendances = AttendanceEmployee::query()->whereDate('date','<', date('Y-m-d'))->where('clock_out','00:00:00')->update([
            'clock_out' => '23:59:59'
        ]);
        ...
        if (!empty($todayAttendance) && $todayAttendance->clock_out == '00:00:00') {
            ...
            return redirect("/")->with('success', __('Employee successfully clock Out.'));
            ...
            if (Auth::user()->type == 'employee') {
                ...
                return redirect("/")->with('success', __('Employee attendance successfully updated.'));
            }
        } else {
