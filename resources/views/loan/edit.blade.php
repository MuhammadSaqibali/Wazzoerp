<div class="card bg-none card-box">
    ...
    <div class="card-body p-0">
        <div class="row">
            ...
            {{ Form::label('loan_installments', __('Loan Installments'),['class'=>'form-control-label']) }}<span class="text-danger">*</span>
            {{ Form::select('loan_installments',array('3_months' => "3 Months",'6_months' => "6 Months",'9_months' => "9 Months",'12_months' => "12 Months"),null, array('class' => 'form-control select2','required'=>'required')) }}
        </div>
            <div class="col-md-6">
                <div class="form-group">
              ...
              <div class="form-group col-md-6 ">
            {{ Form::label('loan_type', __('Loan Type'),['class'=>'form-control-label']) }}<span class="text-danger">*</span>
            {{ Form::select('loan_type',array('flat'=>'Flat','percent'=>'Percent'),null, array('class' => 'form-control select2','required'=>'required')) }}
        </div>
