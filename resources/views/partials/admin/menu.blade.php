                                    ...
                                    <ul class="nav flex-column">
                                        <ul class="nav flex-column">
                                            <li class="nav-item submenu-li">
                                                ...
                                                <div class="submenu-ul {{ (Request::segment(1) == 'bugstatus' || Request::segment(1) == 'project-task-stages') ? 'show' : 'collapse'}}" id="taskgo_navbar_constants" >
                                                    <ul class="nav flex-column">
                                    ...
                                    <ul class="nav flex-column">
                                        <ul class="nav flex-column">
                                            ...
                                            <li class="nav-item submenu-li ">
                                                ...
                                                <div class="submenu-ul {{ (Request::segment(1) == 'setsalary' || Request::segment(1) == 'payslip') ? 'show' : 'collapse'}}" id="navbar-accounting8-users" >
                                                    <ul class="nav flex-column">
                                ...
                                <div class="collapse show" id="navbar-hr" >
                                    <ul class="nav flex-column">
                                        <li class="nav-item submenu-li ">
                                            ...
                                            <div class="submenu-ul {{ (Request::segment(1) == 'leave' || Request::segment(1) == 'attendanceemployee') ? 'show' :'collapse'}}" id="navbar-hr-leave_management" >
                                                <ul class="nav flex-column">
                                                    @can('manage leave')
                                                            ...
                                                            <ul class="nav flex-column">
                                                                <ul class="nav flex-column">
                                                                    <li class="nav-item submenu-li ">
                                                                        ...
                                                                        <div class="submenu-ul {{ (Request::segment(1) == 'attendanceemployee') ? 'show' : 'collapse'}}" id="navbar-attendance" >
                                                                            <ul class="nav flex-column">
                                    ...
                                    <ul class="nav flex-column">
                                        <ul class="nav flex-column">
                                            <li class="nav-item submenu-li ">
                                                ...
                                                <div class="submenu-ul {{ (Request::segment(1) == 'indicator' || Request::segment(1) == 'appraisal' || Request::segment(1) == 'goaltracking') ? 'show' : 'collapse'}}" id="navbar-performance" >
                                                    <ul class="nav flex-column">
                                    ...
                                    <ul class="nav flex-column">
                                        <ul class="nav flex-column">
                                            <li class="nav-item submenu-li ">
                                                ...
                                                <div class="submenu-ul {{ (Request::segment(1) == 'trainer' || Request::segment(1) == 'training') ? 'show' : 'collapse'}}" id="navbar-training" >
                                                    <ul class="nav flex-column">
                                                        @can('manage training')
                            ...
                            <li class="nav-item">
                                <div class="collapse show" id="recruitment-navbar" >
                                    <ul class="nav flex-column">
                                        <ul class="nav flex-column">
                                            <li class="nav-item submenu-li">
                                                <a class="nav-link {{ (Request::segment(1) == 'job' || Request::segment(1) == 'job-application' || Request::segment(1) == 'candidates-job-applications' || Request::segment(1) == 'job-onboard' || Request::segment(1) == 'custom-question' || Request::segment(1) == 'interview-schedule' || Request::segment(1) == 'career') ? 'active' : 'collapsed'}}" href="#navbar-recruitment" data-toggle="collapse" role="button" aria-expanded="{{ (Request::segment(1) == 'job' || Request::segment(1) == 'job-application' || Request::segment(1) == 'candidates-job-applications' || Request::segment(1) == 'job-onboard' || Request::segment(1) == 'custom-question' || Request::segment(1) == 'interview-schedule' || Request::segment(1) == 'career') ? 'true' : 'false'}}" aria-controls="navbar-getting-started1">
                                                    {{__('Recruitment')}}
                                                    <i class="fas fa-sort-up"></i>
                                                </a>
                                                <div class="submenu-ul {{ (Request::segment(1) == 'job' || Request::segment(1) == 'job-application' || Request::segment(1) == 'candidates-job-applications' || Request::segment(1) == 'job-onboard' || Request::segment(1) == 'custom-question' || Request::segment(1) == 'interview-schedule' || Request::segment(1) == 'career') ? 'show' : 'collapse'}}" id="navbar-recruitment" >
                                                    <ul class="nav flex-column">
                                                        @can('manage job')
                            ...
                            <li class="nav-item">
                                <div class="collapse show" id="hr-report-navbar" >
                                    <ul class="nav flex-column">
                                        <ul class="nav flex-column">
                                            <li class="nav-item submenu-li ">
                                                <a class="nav-link {{ (Request::segment(1) == 'reports-daily-attendance' || Request::segment(1) == 'reports-monthly-attendance' || Request::segment(1) == 'reports-leave' || Request::segment(1) == 'reports-payroll') ? 'active' : 'collapsed'}}" href="#hr-report" data-toggle="collapse" role="button" aria-expanded="{{(Request::segment(1) == 'reports-monthly-attendance' || Request::segment(1) == 'reports-leave' || Request::segment(1) == 'reports-payroll') ? 'true' : 'false'}}" aria-controls="user">
                                                    {{__('Report')}}
                                                    <i class="fas fa-sort-up"></i>
                                                </a>
                                                <div class="submenu-ul collapse{{ (Request::segment(1) == 'reports-daily-attendance' ||Request::segment(1) == 'reports-monthly-attendance' || Request::segment(1) == 'reports-leave' || Request::segment(1) == 'reports-payroll') ? 'show' : ''}}" id="hr-report" >
                                                    <ul class="nav flex-column">
                                                        <li class="nav-item {{ request()->is('reports-daily-attendance') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse {{ (Request::segment(1) == 'print-setting' || Request::segment(1) == 'customer' || Request::segment(1) == 'vender' || Request::segment(1) == 'proposal' || Request::segment(1) == 'bank-account' || Request::segment(1) == 'bank-transfer' || Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note' || Request::segment(1) == 'taxes' || Request::segment(1) == 'product-category' || Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type' || (Request::segment(1) == 'report' || Request::segment(1) == 'transaction') &&  Request::segment(2) != 'ledger' &&  Request::segment(2) != 'balance-sheet' &&  Request::segment(2) != 'trial-balance' || Request::segment(1) == 'goal' || Request::segment(1) == 'chart-of-account' || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance' || Request::segment(1) == 'bill' || Request::segment(1) == 'expense' || Request::segment(1) == 'addExpense'|| Request::segment(1) == 'bankreconcilation' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note')?'show':''}}" id="navbar-account">
                        <ul class="nav flex-column">
                                    ...
                                    <ul class="nav flex-column">
                                        <ul class="nav flex-column">
                                            <li class="nav-item submenu-li ">
                                                ...
                                                <div class="submenu-ul {{(Request::segment(1) == 'bank-account' || Request::segment(1) == 'bank-transfer')? 'show' :'collapse'}}" id="banking-nav" >
                                                    <ul class="nav flex-column">
                                    ...
                                    <ul class="nav flex-column">
                                        <ul class="nav flex-column">
                                            <li class="nav-item submenu-li ">
                                                ...
                                                <div class="submenu-ul {{(Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note')? 'show' :'collapse'}}" id="income-nav" >
                                                    <ul class="nav flex-column">
                                                        @can('manage invoice')
                            ...
                            <li class="nav-item">
                                <div class="collapse show" id="expense-navbar" >
                                    <ul class="nav flex-column">
                                        <ul class="nav flex-column">
                                            <li class="nav-item submenu-li ">
                                                <a class="nav-link {{(Request::segment(1) == 'bill' || Request::segment(1) == 'expense' || Request::segment(1) == 'addExpense' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note')? 'active' :'collapsed'}}" href="#expense-nav" data-toggle="collapse" role="button" aria-expanded="{{(Request::segment(1) == 'bill' || Request::segment(1) == 'expense' || Request::segment(1) == 'addExpense' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note')? 'true' :'false'}}" aria-controls="navbar-getting-started1">
                                                    {{__('Expense')}}
                                                    <i class="fas fa-sort-up"></i>
                                                </a>
                                                <div class="submenu-ul {{(Request::segment(1) == 'bill' || Request::segment(1) == 'expense' || Request::segment(1) == 'addExpense' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note')? 'show' :'collapse'}}" id="expense-nav" >
                                                    <ul class="nav flex-column">
                                                        @can('manage bill')
                                                        <li class="nav-item {{ (Request::route()->getName() == 'addExpense.expenses' || Request::segment(1) == 'addExpense' || Request::route()->getName() == 'addExpense.receipt') ? ' active' : '' }}">
                                                            <a href="{{ route('addExpense.expenses')}}" class="nav-link">{{ __('Expenses') }}</a>
                                                        </li>
                            ...
                            <li class="nav-item">
                                <div class="collapse show" id="double-enrty-navbar" >
                                    <ul class="nav flex-column">
                                        <ul class="nav flex-column">
                                            <li class="nav-item submenu-li ">
                                                <a class="nav-link {{(Request::segment(1) == 'chart-of-account' || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance')? 'active' :'collapsed'}}" href="#double-enrty-nav" data-toggle="collapse" role="button" aria-expanded="{{(Request::segment(1) == 'chart-of-account' || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance')? 'true' :'false'}}" aria-controls="navbar-getting-started1">
                                                    {{__('Double Entry')}}
                                                    <i class="fas fa-sort-up"></i>
                                                </a>
                                                <div class="submenu-ul {{(Request::segment(1) == 'chart-of-account' || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance')? 'show' :'collapse'}}" id="double-enrty-nav" >
                                                    <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <div class="collapse show" id="report-navbar" >
                                    <ul class="nav flex-column">
                                        <ul class="nav flex-column">
                                            <li class="nav-item submenu-li ">
                                                <a class="nav-link {{((Request::segment(1) == 'report' || Request::segment(1) == 'transaction') &&  Request::segment(2) != 'ledger' &&  Request::segment(2) != 'balance-sheet' &&  Request::segment(2) != 'trial-balance')? 'active' :'collapsed'}}" href="#report-nav" data-toggle="collapse" role="button" aria-expanded="{{((Request::segment(1) == 'report' || Request::segment(1) == 'transaction') &&  Request::segment(2) != 'ledger' &&  Request::segment(2) != 'balance-sheet' &&  Request::segment(2) != 'trial-balance')? 'true' :'false'}}" aria-controls="navbar-getting-started1">
                                                    {{__('Report')}}
                                                    <i class="fas fa-sort-up"></i>
                                                </a>
                                                <div class="submenu-ul {{((Request::segment(1) == 'report' || Request::segment(1) == 'transaction') &&  Request::segment(2) != 'ledger' &&  Request::segment(2) != 'balance-sheet' &&  Request::segment(2) != 'trial-balance')? 'show' :'collapse'}}" id="report-nav" >
                                                    <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <div class="collapse show" id="account-setup-navbar" >
                                    <ul class="nav flex-column">
                                        <ul class="nav flex-column">
                                            <li class="nav-item submenu-li ">
                                                <a class="nav-link {{(Request::segment(1) == 'taxes' || Request::segment(1) == 'product-category' || Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type')? 'active' :'collapsed'}}" href="#account-setup-nav" data-toggle="collapse" role="button" aria-expanded="{{(Request::segment(1) == 'taxes' || Request::segment(1) == 'product-category' || Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type')? 'true' :'false'}}" aria-controls="navbar-getting-started1">
                                                    {{__('Setup')}}
                                                    <i class="fas fa-sort-up"></i>
                                                </a>
                                                <div class="submenu-ul {{(Request::segment(1) == 'taxes' || Request::segment(1) == 'product-category' || Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type')? 'show' :'collapse'}}" id="account-setup-nav" >
                                                    <ul class="nav flex-column">
                            ...
                            @endif
                            <li class="nav-item {{ (Request::route()->getName() == 'bankReconcilation.index' || Request::segment(1) == 'bankreconcilation' ) ? ' active' : '' }}">
                                <a href="{{ route('bankReconcilation.index')}}" class="nav-link">{{ __('Bank Reconcilation') }}</a>
                            </li>
