                                ...
                                <div class="card bg-none mb-0">
                                    <div class="row px-3">
                                        ...
                                        @foreach($saturation_deductions as $deduction)
                                            <div class="col-md-12 form-group">
                                                {!! Form::label('title', $deduction->title,['class'=>'form-control-label','readonly'=>'readonly']) !!}
                                                {!! Form::text('saturation_deductions[]', $deduction->amount, ['class' => 'form-control','readonly'=>'readonly']) !!}
