                ...
                <div class="col-lg-12 our-system">
                    <div class="row">
                        <ul class="nav nav-tabs my-4">
                            ...
                            <li>
                                <a data-toggle="tab" href="#budget" class="">{{__('Budget')}}</a>
                            </li>
                            <li>
            ...
            {{ Form::select('salary_based',array('hourly' => "Hourly",'daily' => "Daily",'fournight' => "Fournight",'weakly' => "Weakly",'monthly' => "Monthly"),null, array('class' => 'form-control select2','required'=>'required')) }}
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::number('salary',null, array('min' => 0,'step'=>'any','class' => 'form-control ','required'=>'required')) }}
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('loan_optionaa', __('Loan Optionsnn'),['class'=>'form-control-label']) }}<span class="text-danger">*</span>
                                            {{ Form::select('loan_option',$loan_options,null, array('class' => 'form-control select2','required'=>'required')) }}
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-4">
