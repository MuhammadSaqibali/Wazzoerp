...
Route::get('gho', function () {
    \Artisan::call('config:cache');
});
route::get('/addExpense', function () {
    return view('addExpense.add_expense');
})->middleware([
    'auth',
    'XSS',
    'revalidate',
...
Auth::routes();
Route::get('/', ['uses' => 'HomeController@index'])->middleware(['XSS'])->name('home');
...
Route::resource('income_tax', 'ITaxController')->middleware(
    [
        'auth'
    ]
);
Route::get('i-taxes/create/{eid}', 'ITaxController@loanCreate')->name('income_tax.create')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('budgets/create/{eid}', 'BudgetController@loanCreate')->name('budget.create')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('reports-daily-attendance', 'ReportController@dailyAttendance')->name('report.daily.attendance')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::post('update-reports-daily-attendance', 'ReportController@postDailyAttendance')->name('post.report.daily.attendance')->middleware(
    [
        'auth',
        'XSS',
    ]
...
route::get('/addExpense', ['App\Http\Controllers\addExpense', 'addExpense'])->middleware([
    'auth',
    'XSS',
    'revalidate',
]);
Route::get('/receipt/{id}', ['App\Http\Controllers\addExpense', 'receipt'])->middleware([
    'auth',
    'XSS',
    'revalidate',
])->name('addExpense.receipt');
Route::post('/insert_expence', ['App\Http\Controllers\addExpense', 'insert'])->middleware([
    'auth',
    'XSS',
    'revalidate',
])->name('addExpense.add_expense');
Route::get('/expense', ['App\Http\Controllers\addExpense', 'show'])->middleware([
    'auth',
    'XSS',
    'revalidate',
])->name('addExpense.expenses');
Route::post('/filter_expence', ['App\Http\Controllers\addExpense', 'filter'])->middleware([
    'auth',
    'XSS',
    'revalidate',
]);
Route::post('/edit_expence', ['App\Http\Controllers\addExpense', 'edit_expence'])->middleware([
    'auth',
    'XSS',
    'revalidate',
]);
...
Route::post('/delete', ['App\Http\Controllers\addExpense', 'destroy'])->middleware([
    'auth',
    'XSS',
    'revalidate',
]);

Route::get('/bankreconcilation', [pdfController::class, 'bankReconcilation'])->middleware([
    'auth',
    'XSS',
    'revalidate',
])->name('bankReconcilation.index');
