                                                        ...
                                                        <ul class="nav flex-column">
                                                            <ul class="nav flex-column">
                                                                <li class="nav-item submenu-li ">
                                                                    ...
                                                                    <div class="submenu-ul collapse<?php echo e((Request::segment(1) == 'reports-daily-attendance' ||Request::segment(1) == 'reports-monthly-attendance' || Request::segment(1) == 'reports-leave' || Request::segment(1) == 'reports-payroll') ? 'show' : ''); ?>" id="hr-report" style="">
                                                                        <ul class="nav flex-column">
...
<?php /**PATH /home/wazzoconsulting/wazzoerp.wazzoconsulting.com/resources/views/partials/admin/menu.blade.php ENDPATH**/ ?>