                        ...
                        <div class="col-md-6">
                            <div class="form-group" id="vender-box">
                                <div class="input-group">
                                    ...
                                    <?php echo e(Form::select('vender_id', $venders,null, array('class' => 'form-control select2','id'=>'vender','data-url'=>route('bill.vender'),'required'=>'required'))); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            ...
                                            <?php echo e(Form::text('bill_date', null, array('class' => 'form-control datepicker','required'=>'required'))); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="25%">
                                    <?php echo e(Form::select('item', $product_services,null, array('class' => 'form-control select2 item','data-url'=>route('bill.product')))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\wazzoerp\resources\views/bill/edit.blade.php ENDPATH**/ ?>