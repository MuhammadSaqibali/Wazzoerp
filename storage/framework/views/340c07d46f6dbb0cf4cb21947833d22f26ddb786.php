                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create timesheet')): ?>
                            <div class="col text-right project_tasks_select">
                                <div class="dropdown btn btn-sm p-0">
                                    <a class="btn btn-sm btn-white float-right add-small" href="<?php echo e(url("/projects/".$project->id.'/task')); ?>" >
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wazzoconsulting/wazzoerp.wazzoconsulting.com/resources/views/projects/timesheets/index.blade.php ENDPATH**/ ?>