                    ...
                    <div class="table-responsive py-4">
                        <table class="table table-striped mb-0" id="report-dataTable">
                            ...
                            <tr>
                                ...
                                <th><?php echo e(__('Trans Curr')); ?></th>
                                <th><?php echo e(__('Trans Amt')); ?></th>
                                <th><?php echo e(__('Enter D or C')); ?></th>
                            ...
                            <?php
                            $budget = null;
                             if($payslip->employees->budgets()->count() > 0)
                             {
                             
                                 $budget =($payslip->employees->budgets[0]);
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(\Carbon\Carbon::parse($payslip->updated_at)->format('d/m/Y')); ?></td>
                                    <td>Monthly Salary <?php echo e(\Carbon\Carbon::parse($payslip->salary_month."-30")->format('M Y')); ?></td>
                                    <td>GBP</td>
                                    <td><?php echo e(\Auth::user()->priceFormat($payslip->net_payble)); ?></td>
                                    <td>---</td>
                                    <td><?php echo e($payslip->employee_id); ?></td>
                                    
                                    <td><?php echo e(!empty($budget)?$budget->funding:""); ?></td>
                                    
                                    <td><?php echo e((!empty($payslip->employees)) ? $payslip->employees->name:''); ?></td>
                                    
                                    
                                    <td><?php echo e(!empty($budget)?$budget->activity:""); ?></td>
                                    <td><?php echo e(!empty($budget)?$budget->grant_:""); ?></td>
                                    <td><?php echo e(!empty($budget)?$budget->functions:""); ?></td>
                                    <td><?php echo e(!empty($budget)?$budget->country:""); ?></td>
                                    <td><?php echo e(!empty($budget)?$budget->csopo:""); ?></td>
                                    <td><?php echo e(!empty($budget)?$budget->donor_report:""); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wazzoconsulting/wazzoerp.wazzoconsulting.com/resources/views/report/payroll.blade.php ENDPATH**/ ?>