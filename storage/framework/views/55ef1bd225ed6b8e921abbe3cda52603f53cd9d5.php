                                                    ...
                                                    <table class="table align-items-center">
                                                        ...
                                                        <?php $__currentLoopData = $saturation_deductions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deduction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                ...
                                                                <td data-op="<?= $deduction->title.'----'.$deduction->amount ?>"><?php echo e(\Auth::user()->priceFormat($deduction->amount)); ?></td>
                                                            </tr>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </tbody>
                                                    </table>
...
<?php /**PATH /home/wazzoconsulting/wazzoerp.wazzoconsulting.com/resources/views/payslip/show.blade.php ENDPATH**/ ?>