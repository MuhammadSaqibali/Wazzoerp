...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(\Auth::user()->type != 'client' && \Auth::user()->type != 'company'): ?>
        <div class="row mt-5">
            ...
            <div class="col-lg-6">
              <?php echo $__env->make('aten',['employeeAttendance' => $employeeAttendance], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wazzoconsulting/wazzoerp.wazzoconsulting.com/resources/views/dashboard/dashboard.blade.php ENDPATH**/ ?>