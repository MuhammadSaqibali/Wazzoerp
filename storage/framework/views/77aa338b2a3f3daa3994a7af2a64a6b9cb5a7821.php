...
<?php echo e(__('Bank Reconcilation')); ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <form action="<?php echo e(route('pdf.upload')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <label for="attachment" class="form-control-lable"><?php echo e(__('Chose file here')); ?></label>
                            <div class="choose-file form-group">
                                <label for="attachment" class="form-control-label">
                                    <div><?php echo e(__('Bank Statement')); ?></div>
        ...
        <div class="col-md-6">
            <?php $__env->startSection('action-button'); ?>
                <div class="row d-flex justify-content-end">
                    <div class="col">
                        <?php echo e(Form::open(array('route' => array('bankReconcilation.index'),'method'=>'get','id'=>'transaction_report'))); ?>
                    ...
                    <div class="col-auto my-custom">
                        ...
                        <a href="<?php echo e(route('bankReconcilation.index')); ?>" class="reset-btn" data-toggle="tooltip" data-original-title="<?php echo e(__('Reset')); ?>">
                                ...
                                <table class="table table-striped mb-0" id="report-dataTable">
                                    ...
                                    <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php if($transaction->account==5): ?>
                                                Custom Expense
                                                <?php else: ?>
                                            ...
                                            <td>
                                                <?php if($transaction->account==5): ?>
                                                <?php echo e(\Auth::user()->priceFormat($transaction->amount)); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\wazzoerp\resources\views/bankReconcilation/index.blade.php ENDPATH**/ ?>