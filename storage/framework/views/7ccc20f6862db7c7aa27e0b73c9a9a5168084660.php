                        ...
                        <div class="card m-3 card-progress border shadow-none" id="<?php echo e($task->id); ?>" style="<?php echo e(!empty($task->priority_color) ? 'border-left: 2px solid '.$task->priority_color.' !important' :''); ?>;">
                            <div class="card-body">
                                <div class="row align-items-center mb-2">
                                    <div class="col-6">
                                        <span class="badge badge-pill badge-xs badge-<?php echo e(\App\ProjectTask::$priority_color[$task->priority]); ?>"><?php echo e(\App\ProjectTask::$priority[$task->priority]); ?></span>
                                    </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-5"><?php if(!empty($task->end_date) && $task->end_date != '0000-00-00'): ?><small <?php if(strtotime($task->end_date) < time()): ?>class="text-danger"<?php endif; ?>><?php echo e(\App\Utility::getDateFormated($task->end_date)); ?></small><?php endif; ?></div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wazzoconsulting/wazzoerp.wazzoconsulting.com/resources/views/project_task/grid.blade.php ENDPATH**/ ?>