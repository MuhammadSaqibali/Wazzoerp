...
<?php $__env->startSection('action-button'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create pay slip')): ?>
        <style>
            .month-year-fiv .select2-container .select2-selection--single{
                color: white !important;
            }
            .month-year-fiv .select2-container--default .select2-selection--single .select2-selection__rendered{
                color: white !important;
            }
        ...
        <div class="row d-flex justify-content-end month-year-fiv">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wazzoconsulting/wazzoerp.wazzoconsulting.com/resources/views/payslip/index.blade.php ENDPATH**/ ?>