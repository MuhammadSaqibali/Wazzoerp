                ...
                <div class="col-md-12">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-md">
                            ...
                            <?php $__currentLoopData = json_decode($payslipDetail['deduction']['deduction']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deduction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /home/wazzoconsulting/wazzoerp.wazzoconsulting.com/resources/views/payslip/pdf.blade.php ENDPATH**/ ?>