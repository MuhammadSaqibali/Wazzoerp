<div class="top-header-part bg-gredient" id="section">
    ...
    <div class="container">
        <div class="row top-bar">
            <div class="col-lg-8 col-md-8 left-part">
                <ul>
                    <li>
                        <a href="#">
                            <img src="" alt="logo" height="60px" width="200px" id="logo">
                        </a>
                    </li>
                    <ul id="menu">
            ...
            <div class="col-lg-4 col-md-4 right-part">
                <ul>
                    <li>
...
<?php /**PATH /home/wazzoconsulting/wazzoerp.wazzoconsulting.com/resources/views/custom_landing_page/custome-top-header-section.blade.php ENDPATH**/ ?>