...
<?php $__env->startSection('content'); ?>
    <div class="row pb-0 overflow-hidden">
        <div class="col-12 container-kanban">
            <div class="board min-750" data-plugin="dragula" data-containers='<?php echo e(json_encode($stageClass)); ?>'>
                <?php $__currentLoopData = $stages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tasks px-0">
                        <div class="m-2">
                            <div class="row">
                                <div class="col-6">
                                    <h6 class="mb-0 mt-0 task-header"><?php echo e($stage->name); ?></h6>
                                </div>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create project task')): ?>
                                    <div class="col-6 text-right">
                                        <div class="actions">
                                            <a class="action-item mr-2" href="#" data-url="<?php echo e(route('projects.tasks.create',[$project->id,$stage->id])); ?>" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Add Task in ').$stage->name); ?>">
                            ...
                            <div class="card-list-body task-list-items" id="task-list-<?php echo e($stage->id); ?>" data-status="<?php echo e($stage->id); ?>">
                                <?php $__currentLoopData = $stage->tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taskDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="card card-progress draggable-item border shadow-none pb-0 mb-0" id="<?php echo e($taskDetail->id); ?>" style="<?php echo e(!empty($taskDetail->priority_color) ? 'border-left: 2px solid '.$taskDetail->priority_color.' !important' :''); ?>;">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                <div class="col-6">
                                                    <span class="badge badge-pill badge-xs badge-<?php echo e(\App\ProjectTask::$priority_color[$taskDetail->priority]); ?>"><?php echo e(__(\App\ProjectTask::$priority[$taskDetail->priority])); ?></span>
                                                </div>
                                                <div class="col-6 text-right">
                                                        ...
                                                        <div class="dropdown action-item">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view project task')): ?>
                                                                    <a href="#" data-url="<?php echo e(route('projects.tasks.show',[$project->id,$taskDetail->id])); ?>" data-ajax-popup="true" class="dropdown-item"><?php echo e(__('View')); ?></a>
                                                                <?php endif; ?>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view project task')): ?>
                                                <a class="h6 task-name-break" href="#" data-url="<?php echo e(route('projects.tasks.show',[$project->id,$taskDetail->id])); ?>" data-ajax-popup="true"><?php echo e($taskDetail->name); ?></a>
                                            <?php endif; ?>
                                            <div class="row align-items-center">
                                                <div class="col-12">
                                                    <div class="actions d-inline-block">
                                                        <?php if(count($taskDetail->taskFiles) > 0): ?>
                                                            <div class="action-item mr-2"><i class="fas fa-paperclip mr-2"></i><?php echo e(count($taskDetail->taskFiles)); ?></div>
                                                        <?php endif; ?>

                                                        <?php if(count($taskDetail->comments) > 0): ?>
                                                            <div class="action-item mr-2"><i class="fas fa-comment-alt mr-2"></i><?php echo e(count($taskDetail->comments)); ?></div>
                                                        <?php endif; ?>

                                                        <?php if($taskDetail->checklist->count() > 0): ?>
                                                            <div class="action-item mr-2"><i class="fas fa-tasks mr-2"></i><?php echo e($taskDetail->countTaskChecklist()); ?></div>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wazzoconsulting/wazzoerp.wazzoconsulting.com/resources/views/project_task/index.blade.php ENDPATH**/ ?>