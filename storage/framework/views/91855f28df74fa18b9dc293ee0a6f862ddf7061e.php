...
<?php $__env->startSection('action-button'); ?>
    <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
        ...
        <a href="#" data-url="<?php echo e(route('projects.edit', $project->id)); ?>" data-size="lg" data-ajax-popup="true"
        data-title="<?php echo e(__('Edit Project')); ?>" class="btn btn-xs btn-white btn-icon-only width-auto">
        <i class="fas fa-pencil-alt"></i> <?php echo e(__('Edit')); ?></a>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage bug report')): ?>
          <a href="<?php echo e(route('task.bug',$project->id)); ?>" class="btn btn-xs btn-white btn-icon-only width-auto">
              <i class="fas fa-bug"></i> <?php echo e(__('Bug Report')); ?>

          </a>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create project task')): ?>
            <a href="<?php echo e(route('projects.tasks.index',$project->id)); ?>" class="btn btn-xs btn-white btn-icon-only width-auto">
                <span class="btn-inner--icon"><i class="fas fa-list"></i><?php echo e(__('Tasks')); ?></span>
            </a>
        <?php endif; ?>
        <?php if(\Auth::user()->type != 'client'): ?>
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view timesheet')): ?>
              <a href="<?php echo e(route('timesheet.index',$project->id)); ?>" class="btn btn-xs btn-white btn-icon-only width-auto">
                  <span class="btn-inner--icon"><i class="fas fa-stopwatch"></i><?php echo e(__('Timesheet')); ?></span>
              </a>
          <?php endif; ?>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view grant chart')): ?>
            <a href="<?php echo e(route('projects.gantt',$project->id)); ?>" class="btn btn-xs btn-white btn-icon-only width-auto">
                <span class="btn-inner--icon"><i class="fas fa-chart-pie"></i><?php echo e(__('Gantt Chart')); ?></span>
            </a>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view expense')): ?>
            <a href="<?php echo e(route('projects.expenses.index',$project->id)); ?>" class="btn btn-xs btn-white btn-icon-only width-auto">
                <span class="btn-inner--icon"><?php echo e(\Auth::user()->currencySymbol()); ?><i class="fa fa-money"></i><?php echo e(__('Expense')); ?></span>
            </a>
        <?php endif; ?>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card card-stats">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <span class="text-sm text-muted"><?php echo e(__('Total Budget').' : '.\Auth::user()->priceFormat($project->budget)); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            ...
                            <div class="actions">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit project')): ?>
                                <a href="#" class="btn btn-sm btn-white float-right add-small" data-url="<?php echo e(route('invite.project.member.view', $project->id)); ?>" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Add Member')); ?>">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create milestone')): ?>
                            <div class="text-right">
                                <a href="#" data-url="<?php echo e(route('project.milestone',$project->id)); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Create New Milestone')); ?>" class="btn btn-sm btn-white float-right add-small">
                                    <span class="btn-inner--icon">
                                        <i class="fas fa-plus"></i>
                                        <?php echo e(__('Add')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wazzoconsulting/wazzoerp.wazzoconsulting.com/resources/views/projects/view.blade.php ENDPATH**/ ?>