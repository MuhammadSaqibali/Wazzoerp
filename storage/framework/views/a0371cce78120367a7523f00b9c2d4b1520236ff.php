                                ...
                                <div class="timeline-block">
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit bill')): ?>
                                            <div class="Action">
                                                <a href="<?php echo e(route('bill.edit',\Crypt::encrypt($bill->id))); ?>" class="edit-icon float-right" data-toggle="tooltip" data-original-title="<?php echo e(__('Edit')); ?>"><i class="fas fa-pencil-alt"></i></a>
                                            </div>
                                        <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\wazzoerp\resources\views/bill/view.blade.php ENDPATH**/ ?>