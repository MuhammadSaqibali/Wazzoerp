                    ...
                    <?php $__currentLoopData = $bugs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bug): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                                ...
                                <span class="d-block text-sm text-muted"><?php echo e($bug->project->project_name); ?>
                            ...
                            <td>
                                <span class="badge badge-pill badge-sm badge-<?php echo e(__(\App\ProjectTask::$priority_color[$bug->priority])); ?>"><?php echo e(__(\App\ProjectTask::$priority[$bug->priority])); ?></span>
                            </td>
                            <td class="<?php echo e((strtotime($bug->due_date) < time()) ? 'text-danger' : ''); ?>"><?php echo e(\App\Utility::getDateFormated($bug->due_date)); ?></td>
                            <td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wazzoconsulting/wazzoerp.wazzoconsulting.com/resources/views/projects/allBugListView.blade.php ENDPATH**/ ?>