                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped mb-0" id="dataTable-manual">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td colspan="13" class="text-dark"><span><?php echo e(__('Custom Expense')); ?></span></td>
                                    </tr>
                                    <tr>
                                        <td class="text-dark"><?php echo e(__('Total')); ?></td>
                                        <?php $__currentLoopData = $chartcExpenseArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td><?php echo e(\Auth::user()->priceFormat($expense)); ?></td>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tr>
                                    </tbody>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\wazzoerp\resources\views/report/expense_summary.blade.php ENDPATH**/ ?>