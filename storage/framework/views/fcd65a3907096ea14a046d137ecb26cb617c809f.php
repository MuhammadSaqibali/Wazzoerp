                                ...
                                <div class="card bg-none mb-0">
                                    <div class="row px-3">
                                        ...
                                        <?php $__currentLoopData = $saturation_deductions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deduction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-12 form-group">
                                                <?php echo Form::label('title', $deduction->title,['class'=>'form-control-label','readonly'=>'readonly']); ?>

                                                <?php echo Form::text('saturation_deductions[]', $deduction->amount, ['class' => 'form-control','readonly'=>'readonly']); ?>
...
<?php /**PATH /home/wazzoconsulting/wazzoerp.wazzoconsulting.com/resources/views/payslip/salaryEdit.blade.php ENDPATH**/ ?>